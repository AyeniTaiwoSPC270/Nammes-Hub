...
Resources, News, NewsDetail, Opportunities, and Admin aren't in the handoff kit yet — they still render `PagePlaceholder`, now restyled to the new tokens (mono orange-600 eyebrow, Newsreader h1, ink-muted body). Build their real layouts as those designs arrive, following the component specs above rather than ad hoc styling — don't invent page designs the handoff hasn't specified.
