...
export default function PageBannerImageUploadField({ label, url, onChange }) {
    ...
    <div className="flex flex-col gap-1.5">
      ...
      {url && (
        <div className="mt-2 flex flex-col gap-2">
          <div className="aspect-[16/9] w-full max-w-[400px] overflow-hidden rounded-md bg-surface-low shadow-md">
